...
class MicroPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create micro_post" do
    assert_difference('MicroPost.count') do
      post micro_posts_url, params: { micro_post: { contents: @micro_post.contents, user_id: @micro_post.user_id } }
    end
  ...
  test "should update micro_post" do
    patch micro_post_url(@micro_post), params: { micro_post: { contents: @micro_post.contents, user_id: @micro_post.user_id } }
